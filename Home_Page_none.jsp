...
<img class="profile_picture" alt="" src="/Multi_Party/resources/images/sig.png">
<img class="profile_picture" alt="" src="/Multi_Party/resources/Profile_Picture/<%="enc.png"%>">
<%} %>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<%String result="";%>
<%List img=dao.select_response_image(sender,d.getContent());%>
<%Iterator img_it=img.iterator();%>
<%while(img_it.hasNext()) {%>
<%User_Response_Bean c=(User_Response_Bean)img_it.next();%>
<%if(d.getContent().equals(c.getImage())){%>
<%result="execute";%>
<img  style="width:500px;height:300px;" alt="" src="/Multi_Party/resources/images/<%=c.getImage()%>">
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;
<a href="Download?file=<%=c.getImage()%>" style="text-decoration:none;color:green">Download</a>
<%}%>
<%}%>
<table>
<tr>
...
&nbsp;&nbsp;
<%if(result!="execute"){%>
<img  style="width:500px;height:300px;" alt="" src="/Multi_Party/resources/images/<%="enc.png"%>">
<%} %>
<a href="Request_Image?image=<%=d.getContent()%>&sender=<%=sender%>&receiver=<%=name%>" style="color:red;text-decoration:none">Request Image</a></span>
</td>
<td>
<!-- <form> -->
<!-- &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; -->
<!-- &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; -->
<!-- <input type="number" name="number" required="required" placeholder="Enter your Secret Key"> -->
<!-- </td> -->
<!-- <td> -->
